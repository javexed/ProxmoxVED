...
# APP is not a display string: the engine lowercases it into NSAPP and fetches
# install/${NSAPP}-install.sh, so this value and that filename must move
# together. Hyphen, not a space — `tr -d ' '` would collapse it to
# "nanoclawwebchat".
APP="NanoClaw-WebChat"
